...
<body>
    <nav class="navbar navbar-expand-md navbar-dark bg-primary">
        <div class="container">
            <a href="<?php echo e(route('home', ['pageTitle' => 'home'])); ?>" class="navbar-brand mb-0 h1"><i class="bi-hexagon-fill me-2"></i> Data
                Master</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav flex-row flex-wrap">
                    <li class="nav-item col-2 col-md-auto"><a href="<?php echo e(route('home', ['pageTitle' => 'home'])); ?>" class="nav-link">Home</a></li>
...
<?php /**PATH C:\Users\HP\Desktop\4tugas\resources\views/employee/edit.blade.php ENDPATH**/ ?>